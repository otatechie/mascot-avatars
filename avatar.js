...
(function () {
    ...
    // Seeded face-trait variants shared across species (V = { eyes, mouth }).
    function eyePair(V, C, dx, dy, s) {
        s = s || 1;
        if (V.eyes === "round") {
            return [circle(-dx, dy, 15 * s, C.bg), circle(dx, dy, 15 * s, C.bg)];
        }
        return [ellipse(-dx, dy, 15 * s, 23 * s, C.bg), ellipse(dx, dy, 15 * s, 23 * s, C.bg)];
    }
    function mouthShape(V, C, y, w) {
        if (V.mouth === "smile") {
            return `<path d="M ${F(-w)} ${F(y)} Q 0 ${F(y + w * 0.9)} ${F(w)} ${F(y)}" fill="none" stroke="${C.bg}" stroke-width="13" stroke-linecap="round"/>`;
        }
        return ellipse(0, y + 8, w, w * 0.72, C.bg);
    }
    ...
    const SPECIES = {
        ghost(rng, C, V) {
            ...
            return {
                ...
                face: [...eyePair(V, C, 52, eyeY, 1.15), mouthShape(V, C, 42, 24)],
            };
        },
        ...
        bear(rng, C, V) {
            ...
            return {
                ...
                face: [...eyePair(V, C, 62, eyeY), ellipse(0, 62, 25, 17, C.bg)],
            };
        },
        ...
        bunny(rng, C, V) {
            ...
            return {
                ...
                face: [...eyePair(V, C, 55, 25, 0.95), mouthShape(V, C, 88, 20)],
            };
        },
        ...
        blob(rng, C, V) {
            ...
            return {
                ...
                face: [...eyePair(V, C, 52, -18, 1.1), mouthShape(V, C, 55, 28)],
            };
        },
        ...
        bird(rng, C, V) {
            ...
            return {
                ...
                face: eyePair(V, C, 55, eyeY),
            };
        },

        dog(rng, C, V) {
            const earTilt = 10 + rng() * 8;
            return {
                topY: -140,
                body: [
                    ellipse(-152, 50, 50, 118, C.p, earTilt),
                    ellipse(152, 50, 50, 118, C.p, -earTilt),
                    circle(0, 10, 150, C.p),
                    ellipse(0, 330, 200, 205, C.p),
                    ellipse(0, 82, 82, 58, C.s),
                ],
                face: [...eyePair(V, C, 58, -25), ellipse(0, 62, 24, 16, C.bg)],
            };
        },

        frog(rng, C, V) {
            const eyeY = -112 + rng() * 8;
            return {
                topY: -164,
                body: [
                    circle(-78, -110, 50, C.p),
                    circle(78, -110, 50, C.p),
                    ellipse(0, 15, 162, 135, C.p),
                    ellipse(0, 320, 190, 210, C.p),
                    circle(-108, 55, 24, C.s),
                    circle(108, 55, 24, C.s),
                ],
                face: [...eyePair(V, C, 78, eyeY, 0.75), mouthShape(V, C, 45, 42)],
            };
        },

        penguin(rng, C, V) {
            const eyeY = -42 + rng() * 12;
            return {
                topY: -140,
                body: [
                    ellipse(-168, 150, 50, 100, C.p, 15),
                    ellipse(168, 150, 50, 100, C.p, -15),
                    circle(0, 0, 140, C.p),
                    ellipse(0, 290, 195, 225, C.p),
                    ellipse(0, 265, 115, 185, C.s),
                    bluntTri(-28, 18, 28, 18, 0, 68, 10, C.bg),
                ],
                face: eyePair(V, C, 52, eyeY, 0.9),
            };
        },

        alien(rng, C, V) {
            const eyeY = -22 + rng() * 10;
            return {
                topY: -223,
                body: [
                    rrect(-62, -195, 14, 80, 7, C.p),
                    rrect(48, -195, 14, 80, 7, C.p),
                    circle(-55, -205, 18, C.p),
                    circle(55, -205, 18, C.p),
                    ellipse(0, -10, 150, 135, C.p),
                    ellipse(0, 320, 185, 210, C.p),
                    ellipse(0, 70, 55, 32, C.s),
                ],
                face: [...eyePair(V, C, 58, eyeY, 1.4), mouthShape(V, C, 62, 17)],
            };
        },
        ...
        mouse(rng, C, V) {
            ...
            return {
                topY: -182,
                body: [
                    circle(-118, -110, 72, C.p),
                    circle(118, -110, 72, C.p),
                    circle(-118, -110, 40, C.s),
                    circle(118, -110, 40, C.s),
                    circle(0, 35, 140, C.p),
                    ellipse(0, 340, 190, 205, C.p),
                ],
                face: [...eyePair(V, C, 52, eyeY, 0.9), mouthShape(V, C, 78, 17)],
            };
        },
    };
    ...
    function renderAvatar(opts) {
        ...
        // Seeded face-trait variants, shared across species.
        const V = {
            eyes: rng() < 0.5 ? "oval" : "round",
            mouth: rng() < 0.5 ? "oval" : "smile",
        };

        const m = SPECIES[speciesName](rng, C, V);
